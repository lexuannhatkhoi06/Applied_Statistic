...
def construct_feature_space(df):
    ...
    logger.info("=== BẮT ĐẦU TRÍCH XUẤT ĐẶC TRƯNG (FEATURE ENGINEERING) ===")
    ...
    # -----------------------------------------------------------------
    logger.info("Đang tính toán Chỉ số Sức mạnh Đội đua (Constructor Strength)...")
    ...
    logger.info(f"Hoàn thành Feature Engineering! Tổng số trường dữ liệu: {df_feat.shape[1]}")
    return df_feat
